...
DiffuseCube::DiffuseCube(glm::vec3 position, glm::vec3 scale, glm::vec3 color)
{
	m_Position = position;
	m_Scale = scale;
	m_Color = color;
	...
	m_Shader = new Shader("res/shaders/diffuseVertex.shader", "res/shaders/diffuseFrag.shader");
}

void DiffuseCube::Draw(glm::mat4 view, glm::mat4 projection, glm::vec3 lightPos, glm::vec3 lightColor)
{
	m_Shader->Bind();
	glm::mat4 model(1.0f);
